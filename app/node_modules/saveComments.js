...
module.exports = function(req, res, next){
  ...
  if(!req.session.email || req.session.email.length <= 0){
    ...
    return res.send(500);
  } else if(req.body.pointId && req.body.comment
      && req.body.pointId.length > 0 && req.body.comment.length > 0){
    console.log('adding comment to existing point', req.body);
    addComment(req.body.pointId, req.body.comment, req.session.email, res);
    ...
    console.log('adding new point', req.body);
